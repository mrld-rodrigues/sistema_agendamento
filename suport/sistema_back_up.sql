...
(16,'João Silva','joao@email.com','11999999999'),
(17,'Cliente Admin','clienteadmin@email.com','123456789'),
(19,'Cliente Admin','clienteadmin@email.com','123456789'),
(20,'João da Silva','joao_silva@email.com','11988887777');
...
(2,'Maria Profissional','Cabeleireira','maria@email.com','11888888888',15,1),
(4,'Tatuador Profissional','Tatuador','caos@email.com','1197777888',40,1);
...
(1,'Jantar Particular','Jantar para 2 pessoas com menu de 4 pratos',240,1700.00,1),
(2,'Corte de cabelo','Corte masculino com tesoura e máquina',30,49.90,1),
(4,'Jantar Algarvio','Jantar menu de 6 patros com especiarias e comiga do Algarve',240,3000.00,1);
...
CREATE TABLE `usuarios` (
  ...
  `tipo` enum('admin','profissional','cliente') NOT NULL,
  ...
  KEY `cliente_id` (`cliente_id`),
  KEY `idx_email` (`email`),
  CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`profissional_id`) REFERENCES `profissionais` (`id`) ON DELETE SET NULL,
  CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE SET NULL
...
(1,'joao@email.com','$2b$12$NrUmmxSRBF.gdis3PVyAz.AMi480XNQPz.uT.GGrX2c87WjK5QvEG','cliente',NULL,16,1),
(2,'maria@email.com','$2b$12$q/.EBcuof5IZE4GvmdKGL.SOg9i3EMI.4FUoKb41rfjz4yGKi5kQ2','profissional',2,NULL,1),
(3,'admin@exemplo.com','$2b$12$BMXPFN3CE1LKY5./NcCRQ.JXHiVIHfmOxFdRAK5vf74FdLfDMxKWW','admin',NULL,NULL,1),
(4,'carlos@email.com','$2b$12$Djc14GTFIhkO.VxiRnPEzeGZe57Ak/Aoq9fN0TriYGzqCG24OzOza','profissional',1,NULL,1),
(5,'caos@email.com','$2b$12$QpnrBuHbSQ2aAHdWZ.pPHu2q6BHtOYMALmy1aXI24u98q8NJItJ6G','profissional',4,NULL,1),
(6,'joao_silva@email.com','$2b$12$5NS0K5SA8kUnRuM5c8diIOgw/Y4llmNWO9CxeWykaerF1qC5tkQOm','cliente',NULL,20,1);
...
-- Dump completed on 2026-02-23 12:50:17
